...
import { Mail, Lock, AlertCircle, Wallet, User } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center p-4 transition-colors duration-300">
      <div className="w-full max-w-md space-y-8 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 p-8 rounded-2xl shadow-xl">
        ...
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-bold text-slate-800 dark:text-white">إنشاء حساب جديد في ثروتي</h2>
          <p className="text-sm text-slate-500 dark:text-slate-400">ابدأ رحلة تنظيم وتتبع أموالك وديونك اليوم مجاناً.</p>
        </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                type="text"
                required
                placeholder="مثال: عبد الله الغامدي"
                value={fullName}
